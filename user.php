...
return array(
    ...
    "two_fa_verify_desc"               => "Загрузите и установите одно из следующих приложений, и отсканируйте QR-код или введите секретный ключ. Это позволит добавить вашу учетную запись в аутентификатор на вашем устройстве, затем вы сможете просмотреть ее и сгенерировать 6-значный цифровой код, который вы должны ввести выше, чтобы проверить и завершить настройку. Пожалуйста, убедитесь, что вы нажали # Подтвердить # до истечения срока действия кода. Время вашего сервера должно быть синхронизировано с NTP-сервером для правильной работы. ",
