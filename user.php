...
return array(
    ...
    "user"                          => "Kullanıcı|Kullanıcı",
    "user_details"                  => "Kullanıcı Detayları",
    "add_user"                      => "Kullanıcı Ekle",
    "account_active"                => "Aktif Hesap",
    "account_active_desc"           => "Kimliği doğrulanmış bölümlere erişimi etkinleştirmek ve devre dışı bırakmak için geçiş yapın.",

    "op_settings_dept_desc"         => "Operatörün talepleri hangi bölümlerde görüntüleyebileceğini ve yanıtlayabileceğini seçin.",

    "organisation"                  => "Organizasyon|Organizasyon",
    "members"                       => "Üye|Üye",
    "owner"                         => "Sahip",
    "manager"                       => "Yönetici",
    "access_level"                  => "Erişim Seviyesi",
    "access_level_desc"             => "Aşağıdaki bilgilere dayanarak kuruluştaki kullanıcı için erişim düzeyini tanımlayın:<br /><strong>Yönetici</strong> - Kuruluştaki tüm kullanıcılar tarafından açılan talepleri görüntüleyebilir ve kuruluştaki kullanıcıları yönetebilir<br /><strong>Kullanıcı</strong> - Yalnızca kendi kendine açılan biletleri görüntüleyebilir",
    "manage_organisation"           => "Kuruluşu Yönet",
    "leave_organisation"            => "Kuruluştan Ayrıl",
    "user_membership"               => "Kullanıcı üyeliği",
    ...
    "logout"                        => "Çıkış",
    "return_to_login"               => "Giriş İşlemine Dön",

    "user_register_disabled"        => "Üzgünüz, genel kullanıcı kaydı şu anda devre dışı.",
    "success_register"              => "Hesap başarıyla kaydedildi!",
    "register_now"                  => "Şimdi üye Ol",
    "register"                      => "Kayıt ol",
    "register_account"              => "Hesap Aç",
    "signed_up"                     => "Kayıt olun",
    ...
    "operator_login_log"            => "Operatör Giriş Günlüğü",
    "system_activity_log"           => "Sistem Etkinlik Günlüğü",
    "activity_log"                  => "Etkinlik Günlüğü",

    "mass_email"                    => "Toplu E-posta Gönder",
    ...
    "personal_settings_desc"        => "Kendi profilinizi güncelleyin ve yalnızca operatör hesabınızla ilgili ayarları değiştirin.",
    ...
    "view_email"                    => "E-postayı Görüntüle",
    ...
    "manager_notifications"         => "Organizasyon Yöneticisi Bildirimleri",
    "manager_notifications_desc"    => "Kuruluş yöneticileri, varsayılan olarak kuruluştaki diğer kullanıcılar tarafından açılan biletlerin e-posta güncellemelerini almalıdır. Her yöneticinin profilinde bunun için kendi kişisel seçeneği olacaktır ve bu ayarı geçersiz kılabilir.",
    ...
    "organisation_access_level"     => "Kuruluş Erişim Düzeyi",
    "organisation_notifications"    => "Kuruluş Bildirimleri",
    "organisation_users"            => "Kuruluş Kullanıcıları",
    "organisation_users_ticket"     => "Yukarıda, bu ticket ile ilgili güncellemelerin e-postayla gönderileceği kuruluşunuzun yöneticilerinin bir listesi bulunmaktadır.",
    ...
    "personal_confirm_password"     => "PLütfen yeni bir şifre belirlemek için mevcut şifrenizi onaylayın.",
