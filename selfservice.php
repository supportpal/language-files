...
return array(
    ...
    "moderated"                 => "Moderiert",
    "unmoderated"               => "Nicht moderiert",
    "comment_threshold"         => "Kommentar Grenzwert",
    "comment_threshold_desc"    => "Kommentare mit einer niedrigeren Bewertung haben eine geringere Sichtbarkeit und müssen aktiv ausgewählt werden um mehr zu sehen.",

    "enable_ratings"            => "Aktiviere Artikel Bewertungen",
     ...
     * 2.1.0
     */
    "view_articles"             => "Betrachte Artikel",
    "view_categories"           => "Betrachte Kategorien",
    "add_to_another_type"       => "Zu einem anderen Typ hinzufügen",
    "select_type"               => "Typ auswählen...",
    "visibility"                => "Sichtbarkeit",
    "reply_to_comment"          => "beantworte Kommentar",
    "article_brand_warning"     => "Dieser Artikel stammt aus einer anderen Marke, alle Änderungen werden auch in seiner Marke angezeigt.",
    "viewing_article"           => "Artikel betrachten",
