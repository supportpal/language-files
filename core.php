...
return array(
    ...
    "carefully_crafted"         => "Тщательно разработано",
    ...
    "submit_ticket_desc"        => "Используйте эту форму, чтобы отправить заявку в наш высококвалифицированный персонал.",
    "track_ticket"              => "Отследить тикет",
    "track_ticket_desc"         => "Не зарегистрирован? Используйте свой адрес электронной почты и номер тикета, чтобы отслеживать статус вашего тикета.",
    ...
    "cron_makesure"             => "Пожалуйста, создайте работу cron со следующей записью: ",
    ...
    "company_name_desc"         => "Название вашей компании используется для всей переписки с пользователями.",
    ...
    "ticket_desc2"              => "Сетка заявок может быть заказана, отфильтрована, а расположение столбцов настроено по вашему усмотрению.",
    ...
    "frontend_template"         => "Frontend шаблон",
    ...
    "frontend_logo"             => "Frontend логотип",
    ...
    "brand_name_desc"           => "Название бренда, для конечных пользователей.",
    ...
    "frontend_logo_desc"        => "Измените логотип по умолчанию в интерфейсе внешнего интерфейса для этого бренда. Поле может быть либо путем относительно базового каталога (мы рекомендуем хранить ваш логотип в resources/assets/ folder) или прямой URL к изображению.",
    ...
    "upload_unknown_error"      => "Файл \":file\" не был загружен из-за ошибки на стороне сервера.",
    ...
    "new_brand_preview"         => "Для новых брендов опция предварительного просмотра будет использовать данные бренда по умолчанию.",
    "frontend_logo_url"         => "Frontend лого URL",
    "frontend_logo_url_desc"    => "Веб-страница для отправки пользователю после нажатия на логотип. По умолчанию перенаправляет на домашнюю страницу портала поддержки.",
    "favicon"                   => "Favicon",
    ...
    "operator_icon"             => "Значок оператора",
    "operator_icon_desc"        => "Измените значок по умолчанию на интерфейсе оператора для этой марки. Поле может быть либо путем относительно базового каталога (мы рекомендуем хранить ваш логотип в папке resources / assets /), либо прямым URL-адресом изображения. Мы рекомендуем прозрачную пиктограмму с белым цветом, которая масштабируется от 32x32px до 80x80px.",
    ...
    "recaptcha_secret_key"      => "Ключ сайта",
    ...
    "query_logs_desc"           => "Эти журналы содержат все запросы MySQL, которые выполняются при использовании справочной службы. Журналы сохраняются только в том случае, если режим отладки включен вручную в файле конфигурации приложения.",
