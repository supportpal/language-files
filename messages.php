...
return array(
    ...
    "show_all_results"      => "نمایش تمامی نتایج &raquo;",

    "are_you_sure"          => "آیا مطمئن هستید؟",
    "yes_im_sure"           => "بله مطمئن هستم",

    "success_created"       => ":item جدید با موفقیت ایجاد شد",
    "error_created"         => "ایجاد :item جدید با شکست مواجه شد",

    "success_deleted"       => ":item! با موفقیت حذف شد",
    "error_deleted"         => "تلاش برای حذف :item با شکست مواجه شد",

    "success_updated"       => ":item با موفقیت بروزرسانی شد",
    "error_updated"         => "بروزرسانی :item با خطا مواجه شد",

    "error_notfound"        => ":item با شناسه وارد شده وجود ندارد",
    "error_notfound_name"   => ":item با نام وارد شده وجود ندارد",
    "report_notfound"       => "گزارشی با نام و موضوع داده شده وجود ندارد",

    "success_ordering"      => "مرتب سازی با موفقیت بروز شد",
    "error_ordering"        => "بروزرسانی مرتب سازی با خطا مواجه شد",

    "error_login"           => "ورود نا موفق",
    "success_logout"        => "با موفقیت خارج شدید",

    "please_correct"        => "لطفا خطاهای زیر را تصحیح کرده و مجددا تلاش کنید!",

    "success_settings"      => "تنظیمات با موفقیت بروزرسانی شد!",
    "error_settings"        => "بروزرسانی تنظیمات با خطا مواجه شد.",
    ...
    "not_authorised"        => "شما مجاز به انجام این عملیات نیستید!",
    "not_permitted"         => "شما دسترسی مجاز برای مشاهده این صفحه را ندارید. در صورتی که فکر می کنید اشتباهی رخ داده است لطفا با مدیریت تماس بگیرید.",

    "page_not_found"        => "صفحه مورد نظر یافت نشد",
    "cant_find_page"        => "صفحه مورد نظر شما پیدا نشد!",

    "please_report"         => "اگر با خطای غیر منتظره ای مواجه شدین لطفا به مدیریت گزارش دهید.",
    ...
    "maintenance_mode"      => "حالت تعمیر فعال شد! در حال حاضر سیستم برای کاربران در دسترس نیست. فراموش نکنید در پایان ، حالت تعمیر را غیر فعال کنید.",
